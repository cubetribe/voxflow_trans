"""
Core Voxtral Engine with batch processing and streaming support.
...
class VoxtralEngine:
    """
    Main Voxtral processing engine with support for:
    - Large file chunking and batch processing
